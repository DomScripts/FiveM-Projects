Strings = {
    ...
    --? Job Strings
    ["goto-zone"] = "Go to the assigned zone",
    ["not-inZone"] = "This doesn't seem to be in your zone",
    ["already-pickedUp"] = "There is no trash left here",
    ["noTrash-toThrow"] = "You don\'t have any trash to throw away",
    ["return-truck"] = "Go return the truck",

    --? Exchange Strings
    ["cant-carry"] = "You don\'t have enough room to carry",
    ["not-enough"] = "You don\'t have enough for that"
